  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <header className="text-center mb-12 animate-fade-in-up">
        <h1 className="text-4xl md:text-5xl font-bold font-display text-reveillon-primary flex items-center justify-center gap-3">
          <PartyPopper className="h-10 w-10" />
          Cardápio de Réveillon
        </h1>
        <p className="text-muted-foreground mt-2">
          Sugira e vote nos pratos para a nossa festa da virada!
        </p>
      </header>
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <Input
            ...
            className="h-12 text-lg focus-visible:ring-reveillon-primary"
          />
          <Button
